...
use rule * from pypsa_scenario3 exclude retrieve_databundle, retrieve_cutout, download_copernicus_land_cover, retrieve_load_data, build_load_data, retrieve_ship_raster, solve_network as pypsa3_*
use rule * from pypsa_scenario4 exclude retrieve_databundle, retrieve_cutout, download_copernicus_land_cover, retrieve_load_data, build_load_data, retrieve_ship_raster, solve_network as pypsa4_*
