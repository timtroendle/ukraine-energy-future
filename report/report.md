# Context & Scale
Ukraine’s energy system, drastically altered by war, presents a unique opportunity for transformative change. This study offers a roadmap for Ukraine to rebuild its energy infrastructure not just to its former state, but towards a more sustainable, resilient future. By pivoting to renewable energy, Ukraine can reduce its dependence on imported fossil fuels (much of which from hostile Russia) and reduce environmental impacts. Transitioning to wind and solar power is both economically sound and economically viable, challenging the notion that clean energy is too costly.
