# Context & Scale
Ukraine’s energy system, substantially damaged by war, presents a window of opportunity for transformative change. This study offers a roadmap for Ukraine to rebuild its energy infrastructure not just to its former state, but towards a more sustainable, resilient future. By pivoting to renewable energy, Ukraine can reduce its dependence on imported fossil fuels, much of which from Russia, whilst also reducing environmental impacts. Transitioning to wind and solar power is both technically sound and economically viable, challenging the notion that clean energy is too costly.
...
* We couple open models and open data source for reproducible research.
...
Minimal energy system cost is driven by the cost of nuclear when nuclear is set to pre-war levels (55%, @fig:lcoe). Without nuclear in the energy mix, the cost of biomass is dominant (43%) while the total cost of all other renewable generation technologies plays a slightly smaller role (@fig:lcoe). Flexible balancing technologies, namely hydrogen, battery, and pumped-hydro storage, make up 17% of the system cost.

Despite its high cost contribution, biomass plays a smaller role in the electricity mix of the minimal-cost energy supply (@fig:generation). Apart from nuclear with a contribution just above 50%, solar photovoltaics generates the most electricity. Onshore wind turbines also provide significant amounts of electricity, especially without nuclear in the mix. Offshore wind turbines see almost no deployment due to their assumed high cost and sufficient onshore potentials. We did not allow expansion of hydro power whereby it remains at its pre-war level at which its relative importance is substantially reduced. The stark discrepancy between cost and electricity contribution of biomass is caused by its role as flexibility provider in which its capacity factors are low and its specific energy cost is high.
...
```table
---
caption: '**Historic and projected final energy demand by sector and carrier (TWh/yr).** Historic data are taken from ref.\ @StateStatisticsServiceofUkraine:2021. {#tbl:final-energy-demand}'
alignment: LRRRR
